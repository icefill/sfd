            ...
            while
                ...
                if (possible_door.size() ==0) {
                    ...
                    switch (next_direction) {
                        case Constants.DL: current_yyy=current_yyy+1;break;
                        case Constants.DR: current_xxx=current_xxx+1;break;
                        case Constants.UR: current_yyy=current_yyy-1;break;
                        case Constants.UL: current_xxx=current_xxx-1;break;
                    }
                    stack.add(room_array[current_xxx][current_yyy][zzz]);
