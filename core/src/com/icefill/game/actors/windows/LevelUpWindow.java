...
public class LevelUpWindow extends BasicWindow {
	...
	com.icefill.game.actors.dungeon.DungeonGroup dungeon;
	//Table status_table;
	Table ability_table;
	Table outer_table;
	Table left_table;
	...
	public com.icefill.game.actors.dungeon.DungeonGroup getDungeon() {
		return dungeon;
	}
	public void levelUp(final com.icefill.game.actors.dungeon.DungeonGroup dungeon) {
		right_table.clear();
	...
	public void chooseAndAddAbilities(final com.icefill.game.actors.dungeon.DungeonGroup dungeon) {
		// Show stat change
